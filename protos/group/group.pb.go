...
func (x *CreateReq) GetFromUid() int64 {
	if x != nil {
		return x.FromUid
	}
	return 0
...
var file_protos_group_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x22, 0x3a, 0x0a, 0x09, 0x43,
	...
	0x66, 0x72, 0x6f, 0x6d, 0x55, 0x69, 0x64, 0x22, 0x0d, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x39, 0x0a, 0x05, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12,
	0x30, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x67, 0x72,
	0x6f, 0x75, 0x70, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22,
...
var file_protos_group_proto_goTypes = []interface{}{
	(*CreateReq)(nil),   // 0: group.CreateReq
	(*CreateReply)(nil), // 1: group.CreateReply
}
var file_protos_group_proto_depIdxs = []int32{
	0, // 0: group.Group.Create:input_type -> group.CreateReq
	1, // 1: group.Group.Create:output_type -> group.CreateReply
...
func file_protos_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_group_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_group_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
