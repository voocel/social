...
func (u *UserUseCase) UpdateFieldUser(ctx context.Context, uid int64, avatar string) (*ent.User, error) {
...
func (u *UserUseCase) UpdateAddressUser(ctx context.Context, uid int64, avatar string) (*ent.User, error) {
	_, err := u.repo.UpdateAddressUserRepo(ctx, uid, avatar)
	if err != nil {
		return nil, err
	}
	return nil, nil
